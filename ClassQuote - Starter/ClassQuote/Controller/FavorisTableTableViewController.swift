//
//  FavorisTableTableViewController.swift
//  ClassQuote
//
//  Created by Basile on 17/12/2020.
//  Copyright © 2020 OpenClassrooms. All rights reserved.
//

import UIKit

class FavorisTableTableViewController: UITableViewController {
    
    
    var Arrayfinal = ["message" : "test"]

    override func viewDidLoad() {
        super.viewDidLoad()
        
        loadfavoris(p_Array : &Arrayfinal)
    ...
    public func loadfavoris(p_Array : inout [String : String]){
